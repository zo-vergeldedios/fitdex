...
`,
  ...
  l = n(),
  u = c(),
  d = `/assets/react-CHdo91hT.svg`,
  f = `/assets/vite-BF8QNONU.svg`,
  p = `/assets/hero-CLDdwZDr.png`,
  m = e((e) => {
    var t = Symbol.for(`react.transitional.element`),
  ...
  return (0, h.jsx)(h.Fragment, {
    children: (0, h.jsxs)(`section`, {
      ...
      children: [
        ...
        (0, h.jsxs)(`div`, {
          children: [
            (0, h.jsx)(`h1`, { children: `Hello` }),
            (0, h.jsxs)(`p`, {
              children: [
                `Edit `,
                (0, h.jsx)(`code`, { children: `src/App.jsx` }),
                ` and save to test `,
...
(0, u.createRoot)(document.getElementById(`root`)).render(
  (0, h.jsx)(l.StrictMode, { children: (0, h.jsx)(g, {}) }),
);
